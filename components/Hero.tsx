...
const Hero: React.FC = () => {
  ...
  const handleSaveDate = () => {
    const event = {
      title: "Wedding Ceremony of Jyothsna & Chendu",
      details: "Join us to celebrate the union of Dr. K. Jyothsna & K. Chendu, C.A., M.B.A.",
      location: "R.L.N. Kalyana Mandapam, Puthalapattu, Chittoor",
      start: "20260315T020000Z", // Updated based on WEDDING_DATE
      end: "20260315T050000Z"
    };
  ...
  return (
    <section id="hero" className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-[#4A0E0E]">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl">
        ...
        >
          Jyothsna <span className="text-[#FFD700] font-script text-3xl md:text-6xl">&</span> Chendu
        </motion.h1>
