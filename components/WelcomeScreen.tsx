...
const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onOpen }) => {
    ...
    return (
        ...
        >
            ...
            <div
                className="absolute inset-0 bg-cover bg-center opacity-55 blur-sm scale-120"
            ...
            <div className="relative z-10 text-center px-6 max-w-2xl">
                ...
                >
                    ...
                    <h2 className="text-[#FFD700] font-traditional text-lg md:text-2xl tracking-widest mb-2 uppercase">
                        The Koyi Family
                    </h2>
