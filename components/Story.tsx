    ...
    <section id="story" className="py-12 px-4 text-center bg-transparent relative overflow-hidden">
      ...
      >
        <div className="glass-maroon p-10 md:p-16 rounded-[2rem] border-2 border-[#800000]/10 shadow-2xl relative overflow-hidden">
          ...
          >
            "When two hearts are destined to unite, life gently leads the way. From a humble first meeting to sacred wedding vows, this journey has blossomed through love, shared hopes, and countless blessings."
          </motion.p>
          ...
          <div className="flex flex-row justify-center items-center gap-6 sm:gap-12 overflow-visible relative z-10">
            ...
            >
              ...
              <p className="font-traditional font-bold mt-3 text-sm sm:text-xl text-[#800000]">Jyothsna</p>
            </motion.div>
            ...
            >
              ...
              <p className="font-traditional font-bold mt-3 text-sm sm:text-xl text-[#800000]">Chendu</p>
            </motion.div>
          </div>
        </div>
      </motion.div>
